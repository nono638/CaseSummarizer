...
**Current Branch:** `main`
**Status:** ✅ **VOCABULARY EXTRACTION PRODUCTION-READY | 11 BUGS FIXED | DEDUPLICATION + FILTERING | SESSIONS 10-11** - Sessions 10-11 (2025-11-27) fixed 11 critical bugs and added 6 major improvements to vocabulary extraction. Session 10: Fixed common word leaks, increased rarity threshold 75K→150K, fixed ALL CAPS name matching, added entity fragment cleaning, filtered title abbreviations. Session 11: Added legal citation filtering, legal boilerplate filtering, case citation filtering, geographic code filtering, implemented smart deduplication (removes variants and partial names), added law firm detection. **Result**: Reduced output from 506 rows → estimated 50-80 rows of only meaningful proper names and rare medical/technical terms. Production-ready for stenographers.

**Latest Session (2025-11-27 Sessions 10-11 - Vocabulary Extraction Bug Fixes & Advanced Filtering):**
